...
unsigned int m68k_get_reg(void* context, m68k_register_t regnum)
{
	...
	switch(regnum)
	{
		...
		case M68K_REG_PPPC:	return MASK_OUT_ABOVE_32(cpu->pppc);
		case M68K_REG_PPC:	return MASK_OUT_ABOVE_32(cpu->ppc);
		case M68K_REG_IR:	return cpu->ir;
        case M68K_REG_CPU_RUN_MODE: return CPU_RUN_MODE;
        case M68K_REG_CPU_STOPPED: return CPU_STOPPED;
...
//			CPU_ADDRESS_MASK = 0xffffffff;  // GFE clean32 
...
int m68k_execute(int num_cycles)
{
	...
	if(!CPU_STOPPED)
	{
		...
		/* Return point if we had an address or bus error */
		...
		do
		{
            ...
            /* GFE we finished a complete instruction, go back to normal world*/
